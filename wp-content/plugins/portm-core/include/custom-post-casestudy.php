...
class TpCasePost
{
	...
	public function register_custom_post_type() {
		...
		$labels = array(
			'name'                  => esc_html_x( 'Case Study', 'Post Type General Name', 'tpcore' ),
			'singular_name'         => esc_html_x( 'Case Study', 'Post Type Singular Name', 'tpcore' ),
			'menu_name'             => esc_html__( 'Case Study', 'tpcore' ),
			...
			'add_new_item'          => esc_html__( 'Add New Case', 'tpcore' ),
	...
	public function create_cat() {
		$labels = array(
			'name'                       => esc_html_x( 'Case Categories', 'Taxonomy General Name', 'tpcore' ),
			'singular_name'              => esc_html_x( 'Case Categories', 'Taxonomy Singular Name', 'tpcore' ),
			'menu_name'                  => esc_html__( 'Case Categories', 'tpcore' ),
			'all_items'                  => esc_html__( 'All Case Category', 'tpcore' ),
			'parent_item'                => esc_html__( 'Parent Item', 'tpcore' ),
			'parent_item_colon'          => esc_html__( 'Parent Item:', 'tpcore' ),
			'new_item_name'              => esc_html__( 'New Case Category Name', 'tpcore' ),
			'add_new_item'               => esc_html__( 'Add New Case Category', 'tpcore' ),
			'edit_item'                  => esc_html__( 'Edit Case Category', 'tpcore' ),
			'update_item'                => esc_html__( 'Update Case Category', 'tpcore' ),
			'view_item'                  => esc_html__( 'View Case Category', 'tpcore' ),
			...
			'popular_items'              => esc_html__( 'Popular Case Category', 'tpcore' ),
			'search_items'               => esc_html__( 'Search Case Category', 'tpcore' ),
			'not_found'                  => esc_html__( 'Not Found', 'tpcore' ),
			'no_terms'                   => esc_html__( 'No Case Category', 'tpcore' ),
			'items_list'                 => esc_html__( 'Case Category list', 'tpcore' ),
			'items_list_navigation'      => esc_html__( 'Case Category list navigation', 'tpcore' ),
		);
