...
class TP_Core_Plugin {
    ...
    public function tp_core_elementor_category($manager)
    {
        $manager->add_category(
            'tpcore',
            array(
                'title' => esc_html__('Portm Addons', 'tpcore'),
                'icon' => 'eicon-banner',
            )
        );
    }
	...
	public function widget_scripts() {
		...
		wp_register_script( 'tpcore-slider', plugins_url( '/assets/js/main-slider.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_enqueue_script( 'tpcore-slider' );
	}
